...
public class Vegetable {
   ...
   */
   ...
   /**
    ...
    @param newCalories the new caloric count of the vegetable
   */
   public void setCalories(int newCalories){
     ...
     /**
      Returns calories eaten based on how much of the vegetable is eaten
      @param weight the weight of the part of the vegetable that's about to get eaeten
