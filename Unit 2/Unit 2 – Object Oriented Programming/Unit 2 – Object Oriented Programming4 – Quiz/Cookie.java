/**
   ...
   Course:  ICS4U1
   ---------------------------------------
   This Class creates the attributes with the constructor and contains all the methods to call attributes of a Cookie object and mutate all attributes of the Cookie object
*/ 
