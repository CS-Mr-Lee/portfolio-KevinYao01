/**
   ...
   Course:  ICS4U1
   ---------------------------------------
   This Class creates a vegetable and the attributes with the constructor and contains all the methods to call attributes of an object and mutate all attributes of an object
*/ 
